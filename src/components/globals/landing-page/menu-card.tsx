      ...
      <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-8">
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <p className="text-neutral-200 text-left line-clamp-3 mt-4">{description}</p>
            <ShinyButton route={`/menu/${id}`} text="View More" className="mt-3" />
          </motion.div>
        </div>
      </div>
    </div>
  ...
  return (
    ...
    >
      <g filter="url(#filter0_f_120_7473)">
        <circle cx="34" cy="52" r="114" fill="#f97316" />
      </g>
      <g filter="url(#filter1_f_120_7473)">
        <circle cx="332" cy="24" r="102" fill="#d95526" />
      </g>
      <g filter="url(#filter2_f_120_7473)">
        <circle cx="191" cy="53" r="102" fill="#e53f1a" />
      </g>
      <defs>
        <filter
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop offset="0.214779" stopColor="#f97316" />
          <stop offset="0.781583" stopColor="#dc7623" stopOpacity="0" />
        </linearGradient>
        <linearGradient
        ...
        >
          <stop offset="0.214779" stopColor="#f97316" />
          <stop offset="0.781583" stopColor="#e76c18" stopOpacity="0" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0.214779" stopColor="#e76c18" />
          <stop offset="0.781583" stopColor="#f97316" stopOpacity="0" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#df9320" />
          <stop offset="1" stopColor="#d79728" stopOpacity="0" />
        </linearGradient>
        <linearGradient
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#ed8712" />
          <stop offset="1" stopColor="#f67609" stopOpacity="0" />
        </linearGradient>
        <linearGradient
